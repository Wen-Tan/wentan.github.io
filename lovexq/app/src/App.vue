...
2022年09月24日18时26分。你在抖音私信了我，我们的缘分就来啦。
2022年10月01日13时14分。俺给宝贝表白了。我们在一起啦。  
已有 \`${getDateDiff((new Date()).getFullYear()+'-'+((new Date()).getMonth()+1)+'-'+(new Date()).getDate(),'2022-10-01') + 1}\` 天
